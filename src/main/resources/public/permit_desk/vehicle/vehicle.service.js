...
var VehicleService = (function () {
    ...
    VehicleService.prototype.findOne = function (vehicleId) {
        var url = this.baseUrl + "/" + vehicleId;
        return this.http
            .get(url)
            .toPromise()
    ...
    VehicleService.prototype.findAll = function () {
        return this.http
            .get(this.baseUrl)
            .toPromise()
            .then(function (response) { return response.json().data; })
    ...
    VehicleService.prototype.update = function (vehicle) {
        var url = this.baseUrl + "/" + vehicle.vehicleId;
        return this.http
            .put(url, JSON.stringify(vehicle), { headers: this.headers })
            .toPromise()
            .then(function () { return vehicle; })
            .catch(this.handleError);
    };
